...
UNIT_FILE=ROOT/"Unit-05-Developmental-Biology.md"
...
def main():
    ...
    if errors:
        print('Unit 5 validation failed:'); [print('- '+e) for e in errors]; return 1
    print(f"Unit 5 validation passed: {len(answers)} answers, all {MIN_WORDS}-{MAX_WORDS} words, required sections present."); return 0
