...
UNIT_FILE=ROOT/"Unit-04-Entomology-Fish-and-Fisheries.md"
...
def main():
    ...
    if errors:
        print('Unit 4 validation failed:'); [print('- '+e) for e in errors]; return 1
    print(f"Unit 4 validation passed: {len(answers)} answers, all {MIN_WORDS}-{MAX_WORDS} words, required sections present."); return 0
