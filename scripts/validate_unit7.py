...
UNIT_FILE=ROOT/"Unit-07-Cytogenetics-and-Biostatistics.md"
...
def main():
    ...
    if errors:
        print('Unit 7 validation failed:'); [print('- '+e) for e in errors]; return 1
    print(f"Unit 7 validation passed: {len(answers)} answers, all {MIN_WORDS}-{MAX_WORDS} words, required sections present."); return 0
